    ...
    public static void main(String[] args) {
        ...
        for (int num : numbers) {
            ...
            for (int num6 : numbers2) {
                ...
                for (int num7 : numArray) {
                    if (num7 <= numArray.length && num != 7) {
                        System.out.println(num7);
                    }
                }
                int num8 = 0;
                while (num8 < numArray.length && numArray[num8] != 7) {
                    System.out.println(numArray[num8]);
                    num8++;
                }
...
//                }
                ...
                //#13
//                Book book1 = new Book("java", "john", 33);
//                Book book2 = new Book("java", "john", 44);
//                Book book3 = new Book("java", "john", 66);
//
//
